...
/// Formulario de Acta de Recibido a Arrendatario
class ActaRecibidoFormScreen extends StatefulWidget {
  final InventoryProperty property;

  const ActaRecibidoFormScreen({
    super.key,
    required this.property,
  });

  @override
  State<ActaRecibidoFormScreen> createState() => _ActaRecibidoFormScreenState();
}

class _ActaRecibidoFormScreenState extends State<ActaRecibidoFormScreen> {
  ...
  Future<void> _generarPdf() async {
    ...
    try {
      ...
      final fileName = 'acta_recibido_${_actaGuardada!.id}.pdf';
        ...
        build: (context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Center(
                child: pw.Text(
                  'ACTA DE RECIBIDO A ARRENDATARIO',
                  style: pw.TextStyle(
                    fontSize: 18,
                    fontWeight: pw.FontWeight.bold,
                  ),
              ...
              // Texto legal
              pw.Text(
                'Por medio del presente documento, SU TODERO hace constar que ha RECIBIDO del ARRENDATARIO '
                'el inmueble descrito anteriormente, en las siguientes condiciones:',
  ...
  Widget build(BuildContext context) {
    ...
    if (_isLoading) {
      return Scaffold(
        appBar: AppBar(
          title: const Text('Acta de Recibido'),
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Acta de Recibido a Arrendatario'),
        backgroundColor: AppTheme.dorado,
        foregroundColor: AppTheme.negro,
      ),
